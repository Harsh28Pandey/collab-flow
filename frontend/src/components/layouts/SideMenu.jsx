    ...
    return (
        <>
            <div className='w-[235px] lg:w-[245px] h-screen flex flex-col bg-gradient-to-b from-white via-blue-50/20 to-white border-r border-blue-100 z-20'>
                ...
                {/* ✅ ONLY CHANGE: SCROLL RESPONSIVE FIX */}
                <div className="flex-1 overflow-y-auto py-2 px-2 scrollbar-hide custom-scroll">
            ...
            {/* ✅ RESPONSIVE + DESKTOP SCROLL FIX CSS ONLY */}
            <style>{`
