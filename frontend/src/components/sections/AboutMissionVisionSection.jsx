    ...
    return (
        <section className="relative py-24 md:py-32 px-4 md:px-6 bg-[#fafaf9] overflow-hidden flex flex-col items-center">
            ...
            <div className="relative z-10 max-w-6xl mx-auto w-full">
                ...
                {/* Tactile Grand Cards Grid */}
                <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 text-left">
                    {[
                        {
                            title: "Our Mission",
                        ...
                        <div
                            ...
                            className="group relative bg-white/70 backdrop-blur-xl p-10 md:p-14 rounded-[2.5rem]
                        ...
                        >
                            ...
                            {/* Subtle Top Accent */}
                            <div className="absolute top-0 left-10 w-16 h-[2px] bg-gradient-to-r from-orange-300 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                            <div className="relative z-10 flex flex-col items-start">
                                <h3 className="text-2xl md:text-3xl font-extrabold text-slate-800 group-hover:text-orange-600 transition-colors duration-300 mb-4 tracking-tight">
                                    {item.title}
                                </h3>

                                <p className="text-slate-500 text-lg md:text-xl leading-relaxed font-medium tracking-wide">
                                    {item.desc}
                                </p>
                            </div>
                        </div>
