...
const AboutValuesSection = () => {
    return (
        <section className="relative py-16 md:py-24 px-4 md:px-6 overflow-hidden">
            ...
            {/* Background orbs */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[250px] bg-indigo-100 opacity-50 blur-[100px] rounded-full animate-pulse pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[250px] h-[250px] bg-sky-100 opacity-40 blur-[80px] rounded-full animate-pulse [animation-delay:1.5s] pointer-events-none" />
            <div className="absolute bottom-0 right-0 w-[250px] h-[250px] bg-indigo-100 opacity-30 blur-[80px] rounded-full animate-pulse [animation-delay:0.8s] pointer-events-none" />
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
                    {[
                        ...
                        <div
                            ...
                            className="group relative bg-white p-7 rounded-2xl text-center
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <h3 className="text-gray-800 group-hover:text-indigo-600
