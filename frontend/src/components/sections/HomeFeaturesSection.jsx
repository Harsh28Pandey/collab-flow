...
const HomeFeaturesSection = () => {
    return (
        <section className="relative py-16 md:py-24 px-4 md:px-6 overflow-hidden">
            ...
            {/* Background orbs */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[300px] bg-indigo-100 opacity-50 blur-[100px] rounded-full animate-pulse pointer-events-none" />
            ...
            <div className="relative z-10 max-w-6xl mx-auto">
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 text-center">
                    {[
                        ...
                        { title: "Smart Task Management", delay: "0.15s" },
                        { title: "Central Workspace", delay: "0.3s" },
                    ].map((item, i) => (
                        <div
                            key={i}
                            style={{ animationDelay: item.delay }}
                            className="group relative bg-white p-6 md:p-8 rounded-2xl
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <h3 className="font-bold text-lg mb-3 text-gray-800 group-hover:text-indigo-600 transition-colors duration-300">
                                    {item.title}
                                </h3>
