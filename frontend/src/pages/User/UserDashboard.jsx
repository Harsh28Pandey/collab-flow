...
import { LuArrowRight, LuZap, LuTerminal } from 'react-icons/lu';
                            ...
                            <div className='flex flex-col items-center justify-center py-14 px-4 mt-8 bg-zinc-900/50 rounded-[1.5rem] border border-white/5 border-dashed relative z-10'>
                                <div className='w-16 h-16 rounded-2xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center mb-5 shadow-[0_0_20px_rgba(56,189,248,0.15)]'>
                                    <svg width="28" height="28" viewBox="0 0 40 40" fill="none">
                                        <rect x="6" y="8" width="28" height="4" rx="2" fill="#67E8F9" />
                                        <rect x="6" y="16" width="20" height="4" rx="2" fill="#67E8F9" />
                                        <rect x="6" y="24" width="24" height="4" rx="2" fill="#67E8F9" />
                                        <circle cx="32" cy="28" r="8" fill="#38BDF8" />
                                        <path d="M29 28L31 30L35 26" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </div>
                                <h3 className='text-lg md:text-xl font-bold text-white text-center mb-2 tracking-tight'>
                                    No Tasks Assigned Yet 📋
                                </h3>
                                <p className='text-xs sm:text-sm text-zinc-500 font-mono text-center max-w-md leading-relaxed'>
                                    You don't have any tasks assigned yet. Your dashboard will show stats and progress once your admin assigns tasks to you.
                                </p>
                            </div>
                        )}
                    </div>

                    {/* Charts + Recent Tasks — sirf tab dikhenge jab tasks hon */}
                    {dashboardData?.charts?.taskDistribution?.All > 0 && (
